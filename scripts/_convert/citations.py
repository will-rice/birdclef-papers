...
class ResolutionContext:
    """Context passed to resolve_reference — local corpus and current paper's year."""

    corpus_arxiv_to_year: dict[str, str]  # {"2008.10010": "2020", …}
    current_year: str  # year of the citing paper, for relative paths
    s2_cache: dict[str, dict]  # retained for backward compatibility; unused
...
def resolve_reference(ref: Reference, ctx: ResolutionContext) -> None:
    ...
    Priority order:
      ...
      3. DOI
      4. Leave None (citation rendered bare)
    """
